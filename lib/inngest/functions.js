...
//inngest usses : npx inngest-cli@latest dev to invoke the backend 
...
//1Trigger recurring transactions with batching
export const triggerRecurringTransactions = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    //2. create events for each transaction /Send event for each recurring transaction in batches
    if (recurringTransactions.length > 0) {
      ...
      //3. Send events directly using inngest.send() to be processed 
